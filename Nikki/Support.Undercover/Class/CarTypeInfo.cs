...
namespace Nikki.Support.Undercover.Class
{
    ...
    public class CarTypeInfo : Shared.Class.CarTypeInfo
    {
        ...
        /// </summary>
        public const int MaxCNameLength = 0xE;
        ...
        /// </summary>
        public const int BaseClassSize = 0x130;
        ...
        public override void Assemble(BinaryWriter bw)
        {
            ...
            bw.WriteNullTermUTF8(path, 0x40);

            // Write ManufacturerName
            bw.WriteNullTermUTF8(this.ManufacturerName, 0x40);
        ...
        public override void Disassemble(BinaryReader br)
        {
            ...
            this.ManufacturerName = br.ReadNullTermUTF8(0x40);
