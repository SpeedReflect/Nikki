...
namespace Nikki.Core
{
	...
	public static class Map
	{
		...
		internal static Dictionary<BinBlockID, Alignment> BlockToAlignment => new Dictionary<BinBlockID, Alignment>()
		{
			...
			{ BinBlockID.StyleMomentsInfo,  new Alignment(0x80, Alignment.eAlignType.Modular) },
			{ BinBlockID.DifficultyInfo,    new Alignment(0x80, Alignment.eAlignType.Modular) },
			{ BinBlockID.AcidEffects,       new Alignment(0x80, Alignment.eAlignType.Modular) },
			{ BinBlockID.AcidEmitters,      new Alignment(0x80, Alignment.eAlignType.Modular) },
			{ BinBlockID.STRBlocks,         Alignment.Default },
			{ BinBlockID.LangFont,          Alignment.Default },
			{ BinBlockID.Subtitles,         Alignment.Default },
			{ BinBlockID.MovieCatalog,      new Alignment(0x80, Alignment.eAlignType.Modular) },
			{ BinBlockID.ICECatalog,        new Alignment(0x80, Alignment.eAlignType.Modular) },
			{ BinBlockID.WCollisionRaww,    new Alignment(0x800, Alignment.eAlignType.Modular) },
			{ BinBlockID.TPKSettings,       new Alignment(0x80, Alignment.eAlignType.Modular) },
			...
			{ BinBlockID.EAGLSkeleton,      new Alignment(0x80, Alignment.eAlignType.Modular) },
			{ BinBlockID.EAGLAnimations,    Alignment.Default },
			{ BinBlockID.DDSTexture,        new Alignment(0x80, Alignment.eAlignType.Modular) },
			{ BinBlockID.PCAWater0,         new Alignment(0x80, Alignment.eAlignType.Modular) },
			{ BinBlockID.ColorCube,         Alignment.Default },
			{ BinBlockID.GCareer,           new Alignment(0x80, Alignment.eAlignType.Modular) },
			{ BinBlockID.GLimitations,      new Alignment(0x80, Alignment.eAlignType.Modular) },
			{ BinBlockID.AnimDirectory,     Alignment.Default },
			{ BinBlockID.QuickSpline,       new Alignment(0x80, Alignment.eAlignType.Modular) },
			...
			{ BinBlockID.EventSequence,     new Alignment(0x08, Alignment.eAlignType.Actual) },
			{ BinBlockID.DBCarBounds,       new Alignment(0x08, Alignment.eAlignType.Actual) },
			{ BinBlockID.VinylSystem,       new Alignment(0x800, Alignment.eAlignType.Modular) },
			{ BinBlockID.LimitsTable,       Alignment.Default },
			{ BinBlockID.Geometry,          new Alignment(0x80, Alignment.eAlignType.Modular) },
			{ BinBlockID.SpecialEffects,    new Alignment(0x80, Alignment.eAlignType.Modular) },
			{ BinBlockID.PCAWeights,        new Alignment(0x80, Alignment.eAlignType.Modular) },
			{ BinBlockID.TPKBlocks,         new Alignment(0x80, Alignment.eAlignType.Modular) },
		};
	}
}
