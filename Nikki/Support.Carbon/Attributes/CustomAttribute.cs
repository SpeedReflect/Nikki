		...
		public override void Disassemble(BinaryReader br, BinaryReader str_reader)
		{
			switch (this.Type)
			{
				...
				case CarPartAttribType.String:
					var strAttr = new StringAttribute(br, str_reader, 0);
					this.ValueString = strAttr.Value;
					this.ValueStringExists = strAttr.ValueExists;
					return;
				
				case CarPartAttribType.TwoString:
					var twostrAttr = new TwoStringAttribute(br, str_reader, 0);
					this.ValueString1 = twostrAttr.Value1;
					this.ValueString2 = twostrAttr.Value2;
					this.ValueString1Exists = twostrAttr.Value1Exists;
					this.ValueString2Exists = twostrAttr.Value2Exists;
					return;
				
				case CarPartAttribType.Color:
					var colorAttr = new ColorAttribute(br, 0);
					this.ValueColorAlpha = colorAttr.Alpha;
					this.ValueColorBlue = colorAttr.Blue;
					this.ValueColorGreen = colorAttr.Green;
					this.ValueColorRed = colorAttr.Red;
					return;
