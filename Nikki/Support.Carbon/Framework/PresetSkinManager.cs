...
namespace Nikki.Support.Carbon.Framework
{
	...
	public class PresetSkinManager : Manager<PresetSkin>
	{
		...
		/// <summary>
		/// Gets a collection and unit element type in this <see cref="PresetSkinManager"/>.
		/// </summary>
		public override Type CollectionType => typeof(PresetSkin);
		...
		internal override void Assemble(BinaryWriter bw, string mark)
		{
			...
			bw.WriteEnum(BinBlockID.PresetSkins);
		...
		internal override void Disassemble(BinaryReader br, Block block)
		{
			...
			if (block.BlockID != BinBlockID.PresetSkins) return;
