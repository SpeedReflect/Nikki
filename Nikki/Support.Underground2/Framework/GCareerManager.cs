...
{
	/// <summary>
	/// A <see cref="Manager{T}"/> for <see cref="GCareer"/> collections.
	/// </summary>
	public class GCareerManager : Manager<GCareer>
	{
		/// <summary>
		...
		/// <summary>
		/// Name of this <see cref="GCareerManager"/>.
		/// </summary>
		public override string Name => "GCareers";
		...
		/// <summary>
		/// Indicates required alighment when this <see cref="GCareerManager"/> is being serialized.
		/// </summary>
		public override Alignment Alignment { get; }

		/// <summary>
		/// Gets a collection and unit element type in this <see cref="GCareerManager"/>.
		/// </summary>
		public override Type CollectionType => typeof(GCareer);
		...
		/// <summary>
		/// Disassembles data into separate collections in this <see cref="GCareerManager"/>.
		/// </summary>
		...
		internal override void Disassemble(BinaryReader br, Block block)
		{
			...
			if (block.BlockID != BinBlockID.GCareer) return;
			...
			for (int loop = 0; loop < block.Offsets.Count; ++loop)
			{
				...
				var collection = new GCareer(br, this);
