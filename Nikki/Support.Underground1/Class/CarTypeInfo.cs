...
using Nikki.Support.Underground1.Parts.CarParts;
...
namespace Nikki.Support.Underground1.Class
{
    ...
    public class CarTypeInfo : Shared.Class.CarTypeInfo
    {
        ...
        public CarTypeInfo(string CName, Database.Underground1 db)
        {
            this.Database = db;
        ...
        /// <param name="db"><see cref="Database.Underground1"/> to which this instance belongs to.</param>
        public CarTypeInfo(BinaryReader br, Database.Underground1 db)
        {
            this.Database = db;
            this.Initialize();
            this.Disassemble(br);
            if (this.Index <= (int)eBoundValues.MIN_INFO_UNDERGROUND1)
