...
namespace Nikki.Support.Underground1
{
	/// <summary>
	...
	public class Datamap : FileBase
	{
		...
		public Datamap() : base()
		{
			...
			this.Managers.Add(new GCareerRaceManager(this));
		...
		/// <summary>
		/// <see cref="Manager{T}"/> that manages <see cref="GCareerRace"/>.
		/// </summary>
		public GCareerRaceManager GCareerRaces
		{
			get
			{
				var manager = this.GetManager(typeof(GCareerRaceManager));
				return manager == null ? null : manager as GCareerRaceManager;
			}
		}
